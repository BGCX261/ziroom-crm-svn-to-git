...
public class BaseRecordGenerator extends AbstractJavaGenerator {
	...
	private FullyQualifiedJavaType getSuperClass() {
		FullyQualifiedJavaType superClass = new FullyQualifiedJavaType("GeneralCriteria");
		superClass.setExplicitlyImported(true);
		superClass.setPackageName("com.sunshulin.service.GeneralCriteria");
		superClass.setExtendsBoundedWildcard(true);
		superClass.setBaseQualifiedName("com.sunshulin.service.GeneralCriteria");
