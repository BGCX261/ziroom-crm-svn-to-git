...
public class FullyQualifiedJavaType implements
	...
	public void setTypeArguments(List<FullyQualifiedJavaType> typeArguments) {
	...
	public void setBoundedWildcard(boolean boundedWildcard) {
	...
	public void setExtendsBoundedWildcard(boolean extendsBoundedWildcard) {
		this.extendsBoundedWildcard = extendsBoundedWildcard;
	}

	public static void setIntInstance(FullyQualifiedJavaType intInstance) {
		FullyQualifiedJavaType.intInstance = intInstance;
	}

	public static void setStringInstance(FullyQualifiedJavaType stringInstance) {
		FullyQualifiedJavaType.stringInstance = stringInstance;
	}

	public static void setBooleanPrimitiveInstance(FullyQualifiedJavaType booleanPrimitiveInstance) {
		FullyQualifiedJavaType.booleanPrimitiveInstance = booleanPrimitiveInstance;
	}

	public static void setObjectInstance(FullyQualifiedJavaType objectInstance) {
		FullyQualifiedJavaType.objectInstance = objectInstance;
	}

	public static void setDateInstance(FullyQualifiedJavaType dateInstance) {
		FullyQualifiedJavaType.dateInstance = dateInstance;
	}

	public static void setCriteriaInstance(FullyQualifiedJavaType criteriaInstance) {
		FullyQualifiedJavaType.criteriaInstance = criteriaInstance;
	}

	public static void setGeneratedCriteriaInstance(FullyQualifiedJavaType generatedCriteriaInstance) {
		FullyQualifiedJavaType.generatedCriteriaInstance = generatedCriteriaInstance;
	}
	...
	public void setPrimitiveTypeWrapper(PrimitiveTypeWrapper primitiveTypeWrapper) {
