...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectByExampleStatementId("selectList"); //$NON-NLS-1$
        ...
        setBaseResultMapId(fullyQualifiedTable.getDomainObjectName()); //$NON-NLS-1$
        setResultMapWithBLOBsId(fullyQualifiedTable.getDomainObjectName()+"Blob"); //$NON-NLS-1$
        //setExampleWhereClauseId("Example_Where_Clause"); //$NON-NLS-1$
        setBaseColumnListId("column"); //$NON-NLS-1$
        setBlobColumnListId("blob_column"); //$NON-NLS-1$
