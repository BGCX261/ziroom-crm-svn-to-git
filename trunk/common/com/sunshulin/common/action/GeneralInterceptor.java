...
import com.sunshulin.common.exception.GeneralException;
import com.sunshulin.common.log.GeneralLog;
import com.sunshulin.common.log.GeneralManager;
...
public class GeneralInterceptor extends AbstractInterceptor {
	...
	public String intercept(ActionInvocation actionInvocation) throws Exception {
		...
		String invoke = null;
		try {
			ServletActionContext.getRequest().setAttribute("selectedFirst", ServletActionContext.getRequest().getParameter("selectedFirst"));
			ServletActionContext.getRequest().setAttribute("selectedSecond", ServletActionContext.getRequest().getParameter("selectedSecond"));
